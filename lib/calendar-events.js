...
// The same predicate lib/drill-calendar.js's parseIso sits on, imported rather
// than reimplemented. This file used to carry its own copy, written from the
// same idea; it lost the Invalid-Date guard, an impossible-but-well-formed
// '2026-13-01' threw out of validate(), and the request hung for 305 seconds.
// A second copy is a second chance to drift, so there is only one.
const { isIsoCalendarDate: realDate } = require('./drill-calendar');
