...
//
// AGR / AT / Orders and Orders / School – Away pay the same X but differ in one
// thing the squadron rollups care about: whether the member is physically at
// drill. An AGR on station is; an airman at tech school or on orders elsewhere
// is not, and leadership asked to be able to say so (lib/presence.js).
const STATUS_DEFS = [
  { key: 'agr_at_orders',  label: 'AGR / AT / Orders',    pay: 'X', sheetText: 'X - Constructively Present (AGR)' },
  { key: 'orders_away',    label: 'Orders / School – Away', pay: 'X', sheetText: 'X - Constructively Present (AGR)' },
