...
//
//   · any period marked Present, AGR/AT/Orders, or Equivalent Training → present
//     (Equivalent Training is "points only" pay, but the member is on site
//     doing the work — leadership's call, 2026-09-13)
//   · Orders / School – Away is NOT a present status: it pays the same X as
//     AGR/AT/Orders but exists precisely so a supervisor can record that the
//     member is physically elsewhere this drill
...
// else in lib/attendance.js's STATUS_DEFS — Orders/School – Away, RUTA/Excused,
// Unexcused, AWOL, Maternity, Transfer, Separated — means away.
const PRESENT_STATUSES = ['present', 'agr_at_orders', 'equiv_training'];
